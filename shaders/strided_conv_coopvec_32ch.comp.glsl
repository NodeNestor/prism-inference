...
// Strided Conv3x3 32->64 (stride=2) using cooperative vectors
// im2col per output pixel: gather 3x3 x 32 = 288 values, coopVecMatMulAddNV -> 64 outputs
...
layout(push_constant) uniform PC {
    ...
    int weight_offset;  // [64 x 288] row-major
    int bias_offset;    // [64]
...
void main() {
    ...
    // Gather im2col: 32 * 9 = 288 values
    coopvecNV<float16_t, 288> patchVec;
    int p = 0;
    ...
    // Tensor core matmul: [64 x 288] x [288] -> [64]
