...
// WINDOWED Self-Attention — FFN hidden=2048 variant
// Same as base attention_windowed but with 4x wider FFN for scaling benchmarks.
// dim=128, hidden=2048 (base: hidden=512)
...
layout(push_constant) uniform PC {
    ...
    int out_w_offset;
    int out_b_offset;
    int ffn_w1_offset;  // [2048, 128]
    int ffn_b1_offset;
    int ffn_w2_offset;  // [128, 2048]
    int ffn_b2_offset;
    int input_offset;
    int output_offset;
};
...
void main() {
    ...
    // === STEP 4: FFN with hidden=2048 (tensor cores) ===
    coopvecNV<float16_t, 2048> ffn_hidden;
    coopVecMatMulAddNV(ffn_hidden, proj_out, gl_ComponentTypeFloat16NV,
        ...
        2048, 128, gl_CooperativeVectorMatrixLayoutRowMajorNV, false, 128*2);
    ...
    coopVecMatMulAddNV(ffn_out, ffn_hidden, gl_ComponentTypeFloat16NV,
        ...
        128, 2048, gl_CooperativeVectorMatrixLayoutRowMajorNV, false, 2048*2);
