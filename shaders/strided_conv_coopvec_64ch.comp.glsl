...
// Strided Conv3x3 64->128 (stride=2) using cooperative vectors
// im2col per output pixel: gather 3x3 x 64 = 576 values, coopVecMatMulAddNV -> 128 outputs
...
layout(push_constant) uniform PC {
    ...
    int out_width;
    int out_height;
    int weight_offset;  // [128 x 576] row-major
    int bias_offset;    // [128]
...
void main() {
    ...
    // Gather im2col: 64 * 9 = 576 values
    coopvecNV<float16_t, 576> patchVec;
    int p = 0;
    ...
    // Tensor core matmul: [128 x 576] x [576] -> [128]
